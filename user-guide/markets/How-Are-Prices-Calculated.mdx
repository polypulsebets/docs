...
The price of a share represents the **probability** of that outcome occurring, ranging from **1.00** (100%).
...
The protocol ensures that the price of **YES + NO** always equals **1**, _NO_ will automatically trade at **\$0.50**.
